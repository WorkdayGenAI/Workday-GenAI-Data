...
_For: Anyone running the agent on a new machine_
...
| Step | Action |
|------|--------|
| Download | Go to [python.org/downloads](https://python.org/downloads) and click Download Python 3.x |
...
1. Select a translation engine from the radio buttons
2. Upload your `.xlsx` Excel file
3. Review the estimated time and row count
4. Click **Translate**
...
- [ ] Install Python 3.10 or higher from [python.org](https://python.org) — tick **"Add Python to PATH"**
